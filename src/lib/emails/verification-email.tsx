...
const EmailVerification = ({
  ...
  return (
    <Html lang="en" dir="ltr">
      <Tailwind>
        <Head />
        <Body className="bg-[#f5f6f7] font-sans py-[40px]">
          <Container className="mx-auto max-w-[480px]">
            <Section className="bg-white rounded-[16px] shadow-sm mx-[16px] px-[40px] py-[40px]">
              {/* Logo */}
              ...
              {/* Title */}
              <Heading className="text-[28px] font-bold text-[#1a1a1a] text-center mb-[24px] m-0 leading-[1.2]">
                Confirm your email
              </Heading>

              {/* Greeting */}
              <Text className="text-[16px] text-[#1a1a1a] text-center mb-[16px] m-0 leading-[1.5]">
                Hi {userName}! 👋
              </Text>
              ...
              <Section className="text-center mb-[32px]">
                <Button
                  ...
                  className="bg-[#1a1a1a] text-white px-[32px] py-[12px] rounded-[24px] text-[16px] font-medium no-underline box-border inline-block"
                >
                  Confirm Email
                </Button>
              </Section>
